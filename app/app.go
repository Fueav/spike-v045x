...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		spikev045xmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	Spikev045xKeeper spikev045xmodulekeeper.Keeper
...
func New(
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig simparams.EncodingConfig,
	...
	keys := sdk.NewKVStoreKeys(
		...
		spikev045xmoduletypes.StoreKey,
	...
	app.Spikev045xKeeper = *spikev045xmodulekeeper.NewKeeper(
		appCodec,
		keys[spikev045xmoduletypes.StoreKey],
		keys[spikev045xmoduletypes.MemStoreKey],
		app.GetSubspace(spikev045xmoduletypes.ModuleName),
	)
	spikev045xModule := spikev045xmodule.NewAppModule(appCodec, app.Spikev045xKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		spikev045xmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(spikev045xmoduletypes.ModuleName)
