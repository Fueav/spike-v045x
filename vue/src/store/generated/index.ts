...
import SpikeV045XSpikev045XSpikev045X from './spike-v045x/spikev045x.spikev045x'
...
export default { 
  ...
  SpikeV045XSpikev045XSpikev045X: load(SpikeV045XSpikev045XSpikev045X, 'spikev045x.spikev045x'),
